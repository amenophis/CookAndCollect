...
namespace Tests\App\Security\Func\Application\AUserWantsToActivateHisAccount;

use App\Shared\Infrastructure\PHPUnit\BaseTestCase;
use Tests\App\Security\FixturesConstants;

class AUserWantsToActivateHisAccountTest extends BaseTestCase
{
    /**
    ...
    public function provideUserActivateSuccessfully(): iterable
    {
        yield 'Not activated user' => [
            FixturesConstants::USER_NOT_ACTIVATED_ID,
            FixturesConstants::USER_NOT_ACTIVATED_ACTIVATION_TOKEN,
        ];
        yield 'Already activated user' => [
            FixturesConstants::USER_ACTIVATED_ID,
            FixturesConstants::USER_ACTIVATED_ACTIVATION_TOKEN,
        ];
    ...
    {
        $userId              = FixturesConstants::USER_NOT_ACTIVATED_ID;
        $userActivationToken = FixturesConstants::USER_NOT_ACTIVATED_ACTIVATION_TOKEN;
